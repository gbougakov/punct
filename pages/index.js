      ...
      <div className={"max-w-content flex-grow"}>
        ...
        <div className={"mt-12 space-y-12"}>
          ...
          <div className={"space-y-4"}>
            ...
            <p>
              Shows a break in the sentence or instead of a comma, semicolon, or
              colon.
            </p>
            <p className={"text-lg italic"}>
              There are two ways to collect your order <em>&mdash;</em> pick it
              up in store today, or get it delivered tomorrow.
            </p>
            <div className={"flex gap-2 flex-wrap"}>
              <ShiftKey />
              <OptionKey />
          ...
          <div className={"space-y-4"}>
            ...
            <p className={"text-lg italic"}>
              ...
              возьмет тебя!<em>&raquo;</em> &mdash; Так думал молодой повеса...
            </p>
          ...
          <div className={"space-y-4"}>
            ...
            <p>
              Top-level quotation marks in English, second-level quotation marks
              in French and several Cyrillic languages.
            </p>
            <p className={"text-lg italic"}>
          ...
          <div className={"space-y-4"}>
            ...
            <p className={"text-lg italic"}>
              &ldquo;You can use <em>&lsquo;</em>Lorem ipsum...<em>&rsquo;</em>{" "}
              as a placeholder until Dave finishes the copy&rdquo; &mdash; said
              Anna.
            </p>
          </div>
          <div className={"space-y-4"}>
